...
pub struct ImGuiViewportP {
    ...
    pub Idx: cty::c_int,
    pub LastFrameActive: cty::c_int,
    pub LastFrameDrawLists: [cty::c_int; 2usize],
...
extern "C" {
    pub fn igAddContextHook(context: *mut ImGuiContext, hook: *const ImGuiContextHook);
}
extern "C" {
